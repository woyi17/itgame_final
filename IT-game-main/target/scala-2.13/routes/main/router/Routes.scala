...
class Routes(
  ...
  val prefix: String
   ...
   def this(errorHandler: play.api.http.HttpErrorHandler,
    ...
    // @LINE:11
    Assets_1: controllers.Assets
  ) = this(errorHandler, GameScreenController_0, Assets_1, "/")

  def withPrefix(addPrefix: String): Routes = {
    val prefix = play.api.routing.Router.concatPrefix(addPrefix, this.prefix)
    router.RoutesPrefix.setPrefix(prefix)
    new Routes(errorHandler, GameScreenController_0, Assets_1, prefix)
  }
  ...
  def documentation = List(
    ("""GET""", this.prefix, """controllers.GameScreenController.index(request:Request)"""),
  ...
  // @LINE:7
  private[this] lazy val controllers_GameScreenController_index1_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("game")))
  )
  private[this] lazy val controllers_GameScreenController_index1_invoker = createInvoker(
  ...
  // @LINE:8
  private[this] lazy val controllers_GameScreenController_socket2_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("gamews")))
  )
  private[this] lazy val controllers_GameScreenController_socket2_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:7
    case controllers_GameScreenController_index1_route(params@_) =>
      call { 
        controllers_GameScreenController_index1_invoker.call(
          req => GameScreenController_0.index(req))
      }
  
    // @LINE:8
    case controllers_GameScreenController_socket2_route(params@_) =>
      call { 
        controllers_GameScreenController_socket2_invoker.call(GameScreenController_0.socket())
      }
